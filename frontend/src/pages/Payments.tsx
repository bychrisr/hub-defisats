...
export const Payments = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ user_id: '', plan_type: 'free', amount_sats: 0, lightning_invoice: '', status: 'pending' });
    } catch (error) {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Manage Lightning Network payments and subscriptions</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>All payment transactions and subscriptions</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({ ...formData, amount_sats: parseInt(e.target.value) || 0 })}
                  required
                />
              </div>
              <div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, lightning_invoice: e.target.value })}
                required
              />
            </div>
