    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All user notification configurations
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
              ...
              {notifications.map(notification => (
                <TableRow key={notification.id}>
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        notification.is_enabled ? 'default' : 'secondary'
                      }
                    >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={e =>
                  setFormData({ ...formData, channel_config: e.target.value })
                }
                rows={6}
                required
              />
