...
const DYNAMIC_PAGES_CONFIG = {
  ...
  '/admin/monitoring': {
    use_dynamic_title: false,
    use_dynamic_favicon: false,
    custom_title: 'System Monitoring - defiSATS',
    custom_favicon_url: '/favicon-admin.svg',
  },
  '/admin/users': {
    use_dynamic_title: false,
    use_dynamic_favicon: false,
    custom_title: 'User Management - defiSATS',
    custom_favicon_url: '/favicon-admin.svg',
  },
  '/admin/coupons': {
    use_dynamic_title: false,
    use_dynamic_favicon: false,
    custom_title: 'Coupon Management - defiSATS',
    custom_favicon_url: '/favicon-admin.svg',
  },
  '/admin/alerts': {
    use_dynamic_title: false,
    use_dynamic_favicon: false,
    custom_title: 'Alert Management - defiSATS',
    custom_favicon_url: '/favicon-admin.svg',
  },
  '/admin/settings': {
    use_dynamic_title: false,
    use_dynamic_favicon: false,
    custom_title: 'Admin Settings - defiSATS',
    custom_favicon_url: '/favicon-admin.svg',
  },
  '/login': {
    use_dynamic_title: false,
  ...
  '/': {
    use_dynamic_title: false,
    use_dynamic_favicon: false,
    custom_title: 'defiSATS - LN Markets Automation Platform',
    custom_favicon_url: '/favicon.svg',
  },
};
