...
interface AutomationActions {
  fetchAutomations: (params?: { type?: string; is_active?: boolean }) => Promise<void>;
  createAutomation: (data: { type: string; config: any }) => Promise<Automation>;
  updateAutomation: (id: string, data: { config?: any; is_active?: boolean }) => Promise<Automation>;
...
export const useAutomationStore = create<AutomationState & AutomationActions>((set, get) => ({
  ...
  fetchAutomations: async (params) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || 'Failed to fetch automations';
      set({
        isLoading: false,
        error: errorMessage,
      });
  ...
  createAutomation: async (data) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || 'Failed to create automation';
      set({
        isLoading: false,
        error: errorMessage,
      });
  ...
  deleteAutomation: async (id) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || 'Failed to delete automation';
      set({
        isLoading: false,
        error: errorMessage,
      });
  ...
  toggleAutomation: async (id) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || 'Failed to toggle automation';
      set({
        isLoading: false,
        error: errorMessage,
      });
