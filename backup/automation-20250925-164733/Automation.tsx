...
export const Automation = () => {
  ...
  // Usar hook customizado para detecção de mudanças
  ...
  useEffect(() => {
    // Só carregar se não estiver carregando e se ainda não carregou os dados
    if (storeLoading || isDataLoaded) {
      console.log('🔍 AUTOMATION - Skipping load - storeLoading:', storeLoading, 'isDataLoaded:', isDataLoaded);
      return;
    }
    ...
    const newMarginGuard = {
      enabled: marginGuardAutomation?.is_active ?? true, // Usar true como padrão se não há automação
    ...
    const newTpsl = {
      enabled: tpslAutomation?.is_active ?? true, // Usar true como padrão se não há automação
    ...
    // Definir valores originais após carregar dados
    setOriginalValues(newMarginGuard, newTpsl);
    setIsDataLoaded(true);

    console.log('✅ AUTOMATION - Initial values set and original values saved');
  }, [automations, storeLoading, isDataLoaded]);
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full lg:w-auto">
                ...
                <div className="text-xs text-gray-500 mt-2">
                  Debug: hasChanges={hasChanges.toString()}, isLoading={isLoading.toString()}, storeLoading={storeLoading.toString()}
                </div>
              </div>
            </div>
          </div>
                ...
                {marginGuard.enabled && (
                  <div className="space-y-6">
                    ...
                    <div className="grid lg:grid-cols-2 gap-6">
                      ...
                      {/* Percentual de Aumento de Margem */}
                      <div className="space-y-4 p-4 bg-muted/20 rounded-xl">
                        <div className="flex items-center justify-between">
                          <Label className="text-base font-medium text-vibrant">
                            Percentual de Aumento de Margem
                        ...
                        <p className="text-sm text-vibrant-secondary">
                          Adicionar {marginGuard.reduction}% da margem atual para afastar a liquidação quando o limite for atingido
                        </p>
                      </div>
                    </div>
                            ...
                            <>
                              ...
                              <div className="pt-2 border-t border-success/20">
                                ...
                                <div className="mt-1 font-medium text-success">
                                  Adicionar {marginGuard.reduction}% da margem atual ($${
