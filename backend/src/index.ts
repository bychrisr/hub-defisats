...
import { marginGuardPlansRoutes } from './routes/admin/margin-guard-plans.routes';
...
import { automationAccountRoutes } from './routes/automation-account.routes';
...
async function registerRoutes() {
  ...
  console.log('✅ User Exchange Account routes registered');

  // Automation Account routes
  await fastify.register(automationAccountRoutes, { prefix: '/api' });
  console.log('✅ Automation Account routes registered');
  ...
  // WebSocket routes - Registrado sem prefix para /ws direto
  ...
  await fastify.register(exchangesRoutes);
  console.log('✅ Admin routes registered');
  ...
  await fastify.register(marginGuardPlansRoutes, { prefix: '/api/admin/margin-guard' });
  console.log('✅ Margin Guard Admin routes registered');
