...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_automations_user_id_is_active" ON "automations"("user_id", "is_active");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_trade_logs_user_id_created_at" ON "trade_logs"("user_id", "created_at");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_trade_logs_automation_id" ON "trade_logs"("automation_id");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_simulations_user_id_status" ON "simulations"("user_id", "status");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "idx_backtest_reports_user_id_created_at" ON "backtest_reports"("user_id", "created_at");